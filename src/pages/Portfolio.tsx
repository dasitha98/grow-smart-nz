...
const Portfolio = () => {
  useEffect(() => {
    document.title = `${PROFILE.name} — Senior Software Engineer`;
    const desc =
          ...
          <div className="relative max-w-7xl mx-auto px-4 md:px-8 py-20 md:py-32 grid md:grid-cols-[1fr_340px] gap-12 items-center">
            <div className="animate-fade-in">
              ...
              <p className="mt-6 text-base md:text-lg text-white/75 leading-relaxed max-w-2xl">
                5+ years architecting and shipping scalable web and mobile applications.
                I lead teams, design resilient systems, and turn complex requirements into
                products that perform — across fintech, education, and SaaS.
              </p>
          ...
          <div className="max-w-5xl mx-auto px-4 md:px-8 py-20">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <p className="text-lg text-muted-foreground leading-relaxed">
                I'm a Senior Software Engineer with over 5 years of experience designing,
                building, and leading the delivery of scalable full-stack platforms.
                My work spans <span className="text-navy font-semibold">full-stack development</span>,
                <span className="text-navy font-semibold"> project leadership</span>,
                <span className="text-navy font-semibold"> software architecture</span>,
                and <span className="text-navy font-semibold"> technical problem solving</span>.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                I've contributed to international platforms including
                <span className="text-navy font-semibold"> CoinBureau</span> and
                <span className="text-navy font-semibold"> SimpleBooks</span>, and bring
                hands-on experience in <span className="text-navy font-semibold">IT support &amp; systems management</span>.
                I care about clean architecture, well-defined ownership, and shipping
          ...
          <div className="max-w-7xl mx-auto px-4 md:px-8 py-20">
            <div className="text-center mb-12">
              ...
              <p className="mt-4 text-muted-foreground max-w-2xl mx-auto">
                Production platforms I've architected, led, or shipped — across fintech,
                SaaS, education, and operations.
              </p>
            </div>
              ...
              <CardContent className="p-8 md:p-10 grid md:grid-cols-[auto_1fr] gap-6 items-start">
                ...
                <div>
                  ...
                  <p className="mt-3 text-muted-foreground">
                    Research applying NLP techniques to automate pre-interview technical
                    screening and feedback for software engineering candidates.
                  </p>
        ...
        <section id="contact" className="relative overflow-hidden bg-gradient-to-br from-navy via-navy to-[hsl(222,40%,16%)] text-white">
          ...
          <div className="relative max-w-4xl mx-auto px-4 md:px-8 py-20 md:py-28 text-center">
            ...
            <p className="mt-5 text-white/75 text-lg max-w-2xl mx-auto">
              I'm open to senior engineering roles, contract work, and collaborations.
