    ...
    <div className="container-narrow mx-auto py-20 md:py-28 pb-8">
      <div className="grid gap-12 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-5 space-y-3">
            {siteConfig.nav.map((item) => (
              <li key={item.href}>
                <Link to={item.href} className="text-sm text-navy-foreground/50 transition-colors hover:text-gold">
                  {item.label}
                </Link>
              </li>
            ))}
        ...
        <div>
          ...
          <ul className="mt-5 space-y-3">
            <li><Link to="/privacy" className="text-sm text-navy-foreground/50 transition-colors hover:text-gold">Privacy Policy</Link></li>
            <li><Link to="/terms" className="text-sm text-navy-foreground/50 transition-colors hover:text-gold">Terms of Service</Link></li>
          </ul>
        </div>
