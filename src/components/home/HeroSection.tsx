        ...
        <div className="container-narrow mx-auto">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div className="text-center lg:text-left">
              ...
              <h1 className="mx-auto mt-6 max-w-xl text-4xl font-extrabold leading-[30.08] tracking-tight text-foreground sm:text-5xl lg:mx-0 lg:max-w-none lg:text-[3.25rem]">
